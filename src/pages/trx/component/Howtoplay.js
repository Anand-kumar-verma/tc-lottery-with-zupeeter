  ...
  return (
    <>
      ...
      <Box sx={{ padding: '70px 10px 10px 10px', }}>
        ...
        <Typography variant="body1" color="initial" sx={{ ...style.pilwal, mb: 1 }}> How many types of ZP are there?</Typography>
        <Typography variant="body1" color="initial" sx={{ ...style.pilwal, mb: 1 }}> 1. Omni-ZP based on the Bitcoin network, the deposit address is the BTC address, and the deposit and withdrawal go through the BTC network;</Typography>
        <Typography variant="body1" color="initial" sx={{ ...style.pilwal, mb: 1 }}> 2. ERC20-ZP based on the Ethereum ERC20 protocol, the deposit address is the ETH address, and the deposit and withdrawal go through the ETH network;</Typography>
        <Typography variant="body1" color="initial" sx={{ ...style.pilwal, mb: 1 }}>3. TRC20-ZP based on TRON TRC20 protocol and TRX (TRON) network, the deposit address is the TRON address, and the deposit and withdrawal go through the TRON network. </Typography>
        <Typography variant="body1" color="initial" sx={{ ...style.pilwal, mb: 1 }}>TrxHash is the TRC20-ZP Block hash based on the TRON TRC20 protocol and TRX (TRON) network. The last number is used as the result of the lottery to determine whether you have won the lottery (click Block Height to go to the public chain to query the unique Block hash) </Typography>
