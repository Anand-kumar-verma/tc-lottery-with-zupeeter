import { Box, Container, FormControl, Stack, Typography, TextField, FilledInput, InputAdornment, IconButton, FormGroup, FormControlLabel, Checkbox, Select, Button, MenuItem } from "@mui/material";
...
function Login() {
  ...
  return (
    <Container>
      <Box sx={{ padding: 1, background: "linear-gradient(90deg, rgb(255, 153, 1) 0%, rgb(230, 115, 1) 100%)", px: 2, '&>p': { color: 'white' }, }}>
        <NavLink to="/">
          <Box component="img" src={backbtn} width={25}></Box>
        </NavLink>
        <Typography variant="body1" color="initial" sx={{ fontWeight: '600', mt: 2, mb: 1, fontSize: '14px' }}>Log in</Typography>
        <Typography variant="body1" color="initial" sx={{ fontWeight: '400', fontSize: '12px' }}>Please log in with your phone number or email</Typography>
        <Typography variant="body1" color="initial" sx={{ fontWeight: '400', fontSize: '12px', mb: 3 }}>If you forget your password, please contact customer service</Typography>
      </Box>
      ...
      <Box sx={{ width: '92%', margin: 'auto', mt: 3 }}>
          ...
          <Box component='form'>
            ...
            <Box mt={2}>
              <Stack direction='row' alignItems='center'>
                ...
                <Typography variant="body1" color="initial" sx={{ fontSize: '15px', fontWeight: '500', color: 'gray' }}>Password</Typography>
              </Stack>
        ...
        <Box sx={{ width: '80%', margin: 'auto', mt: 3 }}>
          <Button sx={{ boxShadow: ' 0px 3px #b6bad0', padding: '10px', width: '100%', background: '#CACCDB', color: 'white', borderRadius: '20px', mb: 2, fontWeight: '700', '&:hover': { background: '#CACCDB' } }} disableElevation>Log in</Button>
          <NavLink to='/register'>
            <Button sx={{ width: '100%', borderRadius: '20px', fontSize: '17px', fontWeight: '700' }} variant="outlined">Register</Button>
          </NavLink>
        </Box>
        <Box sx={{ mt: 3 }}>
        </Box>
        <Box sx={{ width: '80%', margin: 'auto', }} component={NavLink} to='/CustomerService'>
          <Box component='img' src={custom} sx={{ width: '50px', margin: 'auto' }}></Box>
          <Typography variant="body1" color="initial" sx={{ textAlign: 'center' }}>Customer Service</Typography>
        </Box>
      </Box>
    </Container >
  );
