...
function Wingo() {
    ...
    return (
        <Container>
            ...
            <Box sx={{ padding: 1, background: 'linear-gradient(90deg, rgb(255, 153, 1) 0%, rgb(230, 115, 1) 100%)', px: 2 }}>
                <Box sx={{ background: 'white', padding: 2, borderRadius: '20px', textAlign: 'center' }}>
                    <Stack direction='row' alignItems='center' justifyContent='center'>
                        <Typography variant="body1" color="initial" fontSize="15px" fontWeight={600}>₹ 0.41 </Typography>
            ...
            <Box sx={{ width: '95%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: 'auto', background: '#ededed', borderRadius: '10PX', mt: 2 }}>
                <Box sx={{ width: '25%' }}>
                    <NavLink className={value === 1 ? " wingonavactive wingonav" : " wingonav"} onClick={() => handleChange(1)}>
                        <Box component='img' src={time} width={40}></Box>
                        <Typography variant="body1" color="initial">Win Go</Typography>
                        <Typography variant="body1" color="initial">1 Min</Typography>
                    </NavLink>
                </Box>
                <Box sx={{ width: '25%' }}>
                    <NavLink className={value === 2 ? " wingonavactive wingonav" : " wingonav"} onClick={() => handleChange(2)}>
                        <Box component='img' src={time} width={40}></Box>
                        <Typography variant="body1" color="initial">Win Go</Typography>
                        <Typography variant="body1" color="initial">3 Min</Typography>
                    </NavLink>
                </Box>
                <Box sx={{ width: '25%' }}>
                    <NavLink className={value === 3 ? " wingonavactive wingonav" : " wingonav"} onClick={() => handleChange(3)}>
                        <Box component='img' src={time} width={40}></Box>
                        <Typography variant="body1" color="initial">Win Go</Typography>
                        <Typography variant="body1" color="initial">5 Min</Typography>
                    </NavLink>
                </Box>
                <Box sx={{ width: '25%' }}>
                    <NavLink className={value === 4 ? " wingonavactive wingonav" : " wingonav"} onClick={() => handleChange(4)}>
                        <Box component='img' src={time} width={40}></Box>
                        <Typography variant="body1" color="initial">Win Go</Typography>
                        <Typography variant="body1" color="initial">10 Min</Typography>
                    </NavLink>
                </Box>
            </Box>
            {
