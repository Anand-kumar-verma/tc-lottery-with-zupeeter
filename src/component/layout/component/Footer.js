...
function Footer() {
    ...
    return (
        <Box sx={{ px: 1, backgroundImage: `url(${footer})`, backgroundSize: '100% 100%', }} className="footerBox" >
            <Stack direction='row' sx={{ alignItems: 'center', justifyContent: 'space-around' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', }} component={NavLink} onClick={() => navigation(1)} to='/'>
                    {nav !== 1 ?
                    ...
                    <Typography variant="body1" color="initial" sx={{ fontSize: '11px', fontWeight: 500, color: nav === 1 ? theme.palette.primary.main : 'black' }}>Home</Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', }} component={NavLink} onClick={() => navigation(2)} to='/activity'>
                    {nav !== 2 ?
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', }} component={NavLink} onClick={() => navigation(4)} to='/wallet'>
                    ...
                    <Typography variant="body1" color="initial" sx={{ fontSize: '11px', fontWeight: 500, color: nav === 4 ? theme.palette.primary.main : 'black' }}>Wallet</Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', }} component={NavLink} onClick={() => navigation(5)} to='/account'>
                    {nav === 5 ?
